  ...
  return (
    <>
      ...
      <div className="w-100 mt-5 pb-3">
          ...
          <p className="text-theme-gray text-18">Unlock the latest hair trends: Step up your style game with our top picks of trending wigs</p>
        </div>
          ...
          {cards.map((card, index) => (
            <div key={index} className="card-main border rounded-iconive w-25">
              ...
              <div className="text-start p-3">
                ...
                <button  className="btn px-0 mt-1"> <img src={cardicon2} className="" alt="this is an icon" /></button>
                <button  className="btn ps-2 my-auto"> <img src={cardicon1} className="w-100 " alt="this is an icon" /></button>
                </div>
                </div>
              </div>
            </div> 
