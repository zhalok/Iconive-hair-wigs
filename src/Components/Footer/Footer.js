...
export default function Footer() {
  return (
    <>
      ...
      <div className="py-5  d-flex justify-content-between containerpro w-100">
        <div className="w-30  border-end border-secondary">
          <div>
            ...
            <p className="text-16 text-start ms-2">Accepted Payment Methods</p>
            <div className="text-start">
        ...
        <div className="w-30 d-flex flex-column my-auto">
        ...
        <div className="w-30 px90 d-flex border-start border-secondary">
